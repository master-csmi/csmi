...
--
Le Master CSMI utilise link:https://slack.com/intl/fr-fr/[Slack] pour la communication (promotions, projets, etc.).
...
+ télécharger link:https://ubuntu.com/download/...[Ubuntu 22.04 LTS] ou Debian 11 ou version ultérieure
[emblem]#Windows#::  
+
